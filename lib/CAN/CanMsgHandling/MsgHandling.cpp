...
String CAN_MessagesHandler::make_DTC_code(uint8_t first_msg, uint8_t second_msg)
{
    String code_dtc = "";
...
String CAN_MessagesHandler::Check_type_of_fuel(uint8_t type)
{
    switch (type)
    {
    case 0x01:
...
void CAN_MessagesHandler::Read_DTC(uint8_t *PID, BLE_packet_t *packet)
{
...
void CAN_MessagesHandler::Handling_Message(uint8_t *PID, BLE_packet_t *packet)
{
    switch (*(PID + 2))
    {
